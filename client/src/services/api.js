...
export const gamesAPI = {
  ...
  saveGameScore: (data) => api.post('/games/score/save', data),
  getUserGameScores: (params) => api.get('/games/user/scores', { params }),
  getUserBestScores: () => api.get('/games/user/best-scores'),
  getGameStatistics: (params) => api.get('/games/user/statistics', { params }),
  getGameLeaderboard: (gameId, params) => api.get(`/games/${gameId}/leaderboard`, { params }),
  createGame: (data) => api.post('/games', data),
  updateGame: (gameId, data) => api.put(`/games/${gameId}`, data),
